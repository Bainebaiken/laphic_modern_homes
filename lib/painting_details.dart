    ...
    return Theme(
      ...
      child: Scaffold(
                    ...
                    Container(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final String relatedImage = relatedDesign['image'] ?? 'assets/painting 1.jpg';
                          ...
                          return _RelatedDesignCard(
                            ...
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => PaintingDetailsScreen(design: relatedDesign),
                                ),
                              );
                            },
                          );
        ...
        bottomNavigationBar: BottomNavigationBar(
          currentIndex: 8, // Highlight Painting
...
class _RelatedDesignCardState extends State<_RelatedDesignCard> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      label: 'Related painting design: ${widget.title}, Price: ${widget.price}, Tap to view details',
