...
class ConstructionDetailsScreen extends StatelessWidget {
  ...
  void _onNavTap(BuildContext context, int index) {
    if (index == 1) return; // Stay on Services, as this is a service detail screen
    Widget nextScreen;
    switch (index) {
      case 0:
        nextScreen = const ProfilePage();
      ...
      case 3:
        ...
        break;
      case 4:
        nextScreen = const BookingScreen(initialServiceType: '', initialDesign: '',);
        break;
      case 5:
        nextScreen = const FeedbackInquiryScreen();
        break;
            ...
            Navigator.push(
              ...
              MaterialPageRoute(
                builder: (context) => BookingScreen(
                  initialServiceType: 'Construction', // Pass the service type
                  initialDesign: title, // Pass the design title
                ),
              ),
            );
          },
