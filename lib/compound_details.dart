...
class CompoundDetailsScreen extends StatelessWidget {
  ...
  const CompoundDetailsScreen({Key? key, required this.design}) : super(key: key);

  void _onNavTap(BuildContext context, int index) {
    if (index == 6) return; // Stay on Compound
    Widget nextScreen;
    switch (index) {
      case 0:
    ...
    return Theme(
      ...
      child: Scaffold(
                    ...
                    Container(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final String relatedImage = relatedDesign['image'] ?? 'assets/compound 1.jpg';
                          ...
                          return _RelatedDesignCard(
                            ...
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => CompoundDetailsScreen(design: relatedDesign),
                                ),
                              );
                            },
                          );
        ...
        bottomNavigationBar: BottomNavigationBar(
          currentIndex: 6, // Highlight Compound
...
class _RelatedDesignCardState extends State<_RelatedDesignCard> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      label: 'Related compound design: ${widget.title}, Price: ${widget.price}, Tap to view details',
