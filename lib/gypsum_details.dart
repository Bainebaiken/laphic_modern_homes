...
// class GypsumDetailsScreen extends StatelessWidget {
//   final Map<String, String> design;

//   const GypsumDetailsScreen({Key? key, required this.design}) : super(key: key);

//   void _onNavTap(BuildContext context, int index) {
//     if (index == 2) return; // Stay on Gypsum Works
//     Widget nextScreen;
//     switch (index) {
//       case 0:
...
//                           final String relatedImage = relatedDesign['image'] ?? 'assets/gypsum6.webp';
...
//                                 context,
//                                 MaterialPageRoute(
//                                   builder: (context) => GypsumDetailsScreen(design: relatedDesign),
//                                 ),
//                               );
//                             },
//                           );
...
//           currentIndex: 2, // Highlight Gypsum Works
...
//   Widget build(BuildContext context) {
//     return Semantics(
//       label: 'Related gypsum design: ${widget.title}, Price: ${widget.price}, Tap to view details',
    ...
    final List<Map<String, String>> relatedDesigns = [
      {
        ...
        'price': '500,000 UGX',
        'image': 'assets/gypsum6.webp',
        'description': 'A minimalist gypsum ceiling design, cost-effective and elegant.'
      },
      {
        'title': 'Grey Lights',
        'price': '400,000 UGX',
        'image': 'assets/gypsum6.webp',
        'description': 'Modern gypsum design with integrated grey lighting.'
      },
      {
        'title': 'Humble Lights',
        'price': '500,000 UGX',
        'image': 'assets/gypsum6.webp',
        'description': 'Warm gypsum ceiling with subtle lighting.'
      },
    ];
