...
//   late String _reference; // Store reference ID
...
//   void initState() {
//     super.initState();
//     _reference = "SURVEY-${DateTime.now().millisecondsSinceEpoch}"; // Generate once
//   }
...
//               Text("Reference: $_reference"), // ✅ Using pre-generated reference
//               const SizedBox(height: 10),
//               const Text(
