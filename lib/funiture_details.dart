...
class FurnitureDetailsScreen extends StatelessWidget {
  ...
  const FurnitureDetailsScreen({Key? key, required this.design}) : super(key: key);

  void _onNavTap(BuildContext context, int index) {
    if (index == 4) return; // Stay on Furniture Designs
    Widget nextScreen;
    switch (index) {
      case 0:
    ...
    return Theme(
      ...
      child: Scaffold(
        ...
        body: SingleChildScrollView(
          child: Column(
            ...
            children: [
              GestureDetector(
                onTap: () {
                  // Optional: Add zoom animation or full-screen image viewer
                    ...
                    Container(
                      ...
                      child: ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          final String relatedImage = relatedDesign['image'] ?? 'assets/bed.jpg';
                          ...
                          return _RelatedDesignCard(
                            ...
                            onTap: () {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => FurnitureDetailsScreen(design: relatedDesign),
                                ),
                              );
                            },
                          );
        ...
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            // Navigate to BookingScreen (placeholder; replace with actual screen)
            Navigator.push(
              context,
        ...
        bottomNavigationBar: BottomNavigationBar(
          currentIndex: 4, // Highlight Furniture Designs
...
class _RelatedDesignCardState extends State<_RelatedDesignCard> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Semantics(
      label: 'Related furniture design: ${widget.title}, Price: ${widget.price}, Tap to view details',
